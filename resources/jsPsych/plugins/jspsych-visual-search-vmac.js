...
jsPsych.plugins["visual-search-vmac"] = (function() {
  ...
  jsPsych.pluginAPI.registerPreload('visual-search-vmac', 'foil', 'image');
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function show_search_array() {
      ...
      var after_response = function(info) {
        ...
        if (jsPsych.pluginAPI.compareKeys(info.key,trial.target_horizontal_key) && trial.target_present ||
            jsPsych.pluginAPI.compareKeys(info.key,trial.target_vertical_key) && !trial.target_present) {
          correct = true;
        }
